...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/EliteflixChat')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/Eliteflix_Official')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/Eliteflix_Official')
TUTORIAL = environ.get("TUTORIAL", "https://t.me/EliteflixChat")
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/EliteflixChat")
...
LANGUAGES = [language.lower() for language in environ.get('LANGUAGES', 'hindi english telugu tamil kannada malayalam marathi punjabi odia korean japanese gujrati').split()]
...
STICKERS = [sticker for sticker in environ.get('STICKERS', 'CAACAgUAAxkBAAIjBWafNBfgtCN4VstP5Vr593XLKAABOQAC0wYAAuXVsFTCTPPFFgfD9DQE').split()]  # Multiple sticker can be used separated by space, use @idstickerbot for get sticker id
